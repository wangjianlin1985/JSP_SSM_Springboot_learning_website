...
public class NoticeController extends BaseController {
	...
	public void add(@Validated Notice notice, BindingResult br,
		...
		try {
			notice.setNoticePhoto(this.handlePhotoUpload(request, "noticePhotoFile"));
	...
	public void update(@Validated Notice notice, BindingResult br,
		...
		String noticePhotoFileName = this.handlePhotoUpload(request, "noticePhotoFile");
		if(!noticePhotoFileName.equals("upload/NoImage.jpg"))notice.setNoticePhoto(noticePhotoFileName); 
	...
	public void OutToExcel(String title,String publishDate, Model model, HttpServletRequest request,HttpServletResponse response) throws Exception {
        ...
        String[] headers = { "公告id","标题","新闻公告图片","发布时间"};
        List<String[]> dataset = new ArrayList<String[]>(); 
        for(int i=0;i<noticeList.size();i++) {
        	Notice notice = noticeList.get(i); 
        	dataset.add(new String[]{notice.getNoticeId() + "",notice.getTitle(),notice.getNoticePhoto(),notice.getPublishDate()});
        }
        /*
