...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">英语学习网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <!-- 
                 ...
                 <li><a href="<%=basePath %>VideoComment/frontlist">视频评论</a></li>
                  -->
                <li><a href="<%=basePath %>InfoClass/frontlist">知识分类</a></li>
                <li><a href="<%=basePath %>Video/frontlist">视频学习</a></li>
                <li><a href="<%=basePath %>Xiti/frontlist">习题练习</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        ...
                        <li><a href="<%=basePath %>VideoComment/userFrontlist"><span class="glyphicon glyphicon-heart"></span>&nbsp;&nbsp;我的评论</a></li>
