		       ...
		       text: "知识分类管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "InfoClass/infoClass_add.jsp"
			    	   	},
			    		{
			    	   		text: "知识分类管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "InfoClass/infoClass_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "英语视频管理",
		       ...
		       text: "视频评论管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "VideoComment/videoComment_add.jsp"
			    	   	},
			    		{
			    	   		text: "视频评论管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "VideoComment/videoComment_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "习题管理",
