...
<jsp:include page="../header.jsp"></jsp:include>
	<div class="col-md-9 wow fadeInLeft">
		<ul class="breadcrumb">
  			...
  			<li><a href="<%=basePath %>Notice/frontlist">新闻公告信息列表</a></li>
  			<li class="active">查询结果显示</li>
  			<a class="pull-right" href="<%=basePath %>Notice/notice_frontAdd.jsp" style="display:none;">添加新闻公告</a>
		</ul>
		<div class="row">
			<%
				/*计算起始序号*/
			...
			<div class="col-md-3 bottom15" <%=clearLeft %>>
			  <a  href="<%=basePath  %>Notice/<%=notice.getNoticeId() %>/frontshow"><img class="img-responsive" src="<%=basePath%><%=notice.getNoticePhoto()%>" /></a>
			     <div class="showFields">
			     	<div class="field">
	            		公告id:<%=notice.getNoticeId() %>
			     	</div>
			     	<div class="field">
	            		标题:<%=notice.getTitle() %>
			     	</div>
			     	<div class="field">
	            		发布时间:<%=notice.getPublishDate() %>
			     	</div>
			        <a class="btn btn-primary top5" href="<%=basePath %>Notice/<%=notice.getNoticeId() %>/frontshow">详情</a>
			        <a class="btn btn-primary top5" onclick="noticeEdit('<%=notice.getNoticeId() %>');" style="display:none;">修改</a>
			        <a class="btn btn-primary top5" onclick="noticeDelete('<%=notice.getNoticeId() %>');" style="display:none;">删除</a>
			     </div>
			</div>
			<%  } %>
  ...
  <div class="modal-dialog" style="width:900px;" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="notice_noticePhoto_edit" class="col-md-3 text-right">新闻公告图片:</label>
		  	 <div class="col-md-9">
			    <img  class="img-responsive" id="notice_noticePhotoImg" border="0px"/><br/>
			    <input type="hidden" id="notice_noticePhoto" name="notice.noticePhoto"/>
			    <input id="noticePhotoFile" name="noticePhotoFile" type="file" size="50" />
		  	 </div>
		  </div>
		  <div class="form-group">
	...
	$.ajax({
		...
		success : function (notice, response, status) {
			if (notice) {
				...
				$("#notice_noticePhoto").val(notice.noticePhoto);
				$("#notice_noticePhotoImg").attr("src", basePath +　notice.noticePhoto);
